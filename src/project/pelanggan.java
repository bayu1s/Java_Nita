...
public ResultSet rs;
    ...
    public pelanggan(String keterangan) {
        initComponents();
        kosong();
        kode();
        selamat();
    ...
    protected void kosong(){
       ...
       alamat.setText("");
        ...
        try {
            st = conn.createStatement();
            rs = st.executeQuery("select * from pelanggan order by idpelanggan desc");
            if (rs.next()) {
                String kode = rs.getString("idpelanggan").substring(1);
                ...
                txtkode.setText("C" + Nol + AN);
            } else { 
                txtkode.setText("C001");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void datatable() {
        Object[] Baris = {"ID Pelanggan","Nama PT", "No Telepon","Alamat"};
        ...
        try {
            ...
            while (hasil.next()) {
                String kode = hasil.getString("idpelanggan");
                String Id = hasil.getString("nama");
                String tlp = hasil.getString("tlp");
                String alamt = hasil.getString("alamat");
               
                
                String[] data = {kode,Id,tlp,alamt};
    ...
    private void initComponents() {
        ...
        jPanel5.add(bkembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 52, 47));
        ...
        jPanel5.add(txtcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 190, 190, 30));
        ...
        jPanel5.add(bcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 170, 60, 70));
        ...
        jPanel5.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 240, 650, 237));
        ...
        jPanel5.add(bhapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 550, -1, -1));

        jLabel9.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        jLabel9.setText("Data Pelanggan");
        jPanel5.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 50, -1, -1));
        ...
        jPanel5.add(bbatal, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 550, 110, -1));
        ...
        jPanel5.add(txtkode, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 190, 190, 30));

        jLabel1.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel1.setText("Id Pelanggan");
        jPanel5.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, -1, -1));

        jLabel15.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel15.setText("Nama Pelanggan :");
        jPanel5.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 250, -1, -1));

        txtnama.setBackground(new java.awt.Color(250, 250, 250));
        txtnama.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtnama.setForeground(new java.awt.Color(36, 47, 65));
        ...
        jPanel5.add(txtnama, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 240, 180, 30));

        jSeparator5.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator5.setForeground(new java.awt.Color(0, 0, 0));
        jSeparator5.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 0, 0, 0, new java.awt.Color(0, 0, 0)));
        jPanel5.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 270, 180, -1));

        jLabel7.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel7.setText("Alamat            :");
        jPanel5.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, -1, -1));

        txttlp.setBackground(new java.awt.Color(250, 250, 250));
        txttlp.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txttlp.setForeground(new java.awt.Color(36, 47, 65));
        txttlp.setToolTipText("");
        txttlp.setBorder(null);
        txttlp.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        txttlp.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                txttlpMouseClicked(evt);
            }
        });
        jPanel5.add(txttlp, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 290, 190, 30));

        jSeparator7.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator7.setForeground(new java.awt.Color(0, 0, 0));
        jSeparator7.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 0, 0, 0, new java.awt.Color(0, 0, 0)));
        jPanel5.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 320, 190, -1));
        ...
        jPanel5.add(bubah, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 550, -1, -1));
        ...
        jPanel5.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 350, 240, 120));

        jLabel10.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel10.setText("Nomor Tlp            :");
        jPanel5.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 300, -1, -1));

        jPanel1.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jsupplier.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jbarang.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jPanel1.add(jbarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 370, 170, 50));

        jmasuk.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jPanel1.add(jmasuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, 170, 50));

        jkeluar.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jPanel1.add(jkeluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 170, 50));

        jkaryawan.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jlapor.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jPanel1.add(jlapor, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 170, 50));
        ...
        jPanel1.add(keterangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 80, 23));

        jpelanggan.setBackground(new java.awt.Color(238, 236, 235));
        ...
        jPanel1.add(jpelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 170, 50));
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        if (ok==0){
            String sql = "delete from pelanggan where idpelanggan ='"+txtkode.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "update pelanggan set idpelanggan=?, nama=?, tlp=?, alamat=? where idpelanggan='"+txtkode.getText()+"'";
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txtkode.getText());
            stat.setString(2, txtnama.getText());
            stat.setString(3, txttlp.getText());
