...
public ResultSet rs;
    ...
    public supplier(String keterangan) {
        initComponents();
        kosong();
        kode();
        selamat();
    ...
    protected void kosong(){
       ...
       alamat.setText("");
        ...
        try {
            st = conn.createStatement();
            rs = st.executeQuery("select * from supplier order by idsupplier desc");
            if (rs.next()) {
                String kode = rs.getString("idsupplier").substring(1);
    ...
    protected void datatable() {
        Object[] Baris = {"ID Supplier","Nama Supplier", "No Telepon","Alamat"};
        ...
        try {
            ...
            while (hasil.next()) {
                String kode = hasil.getString("idsupplier");
    ...
    private void initComponents() {
        ...
        jPanel5.add(txtnama, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 190, 30));

        jSeparator5.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator5.setForeground(new java.awt.Color(0, 0, 0));
        jSeparator5.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 0, 0, 0, new java.awt.Color(0, 0, 0)));
        jPanel5.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 270, 190, -1));
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        if (ok==0){
            String sql = "delete from supplier where idsupplier ='"+txtkode.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        // TODO add your handling code here:
         try {
            String sql = "update supplier set idsupplier=?, nama=?, tlp=?, alamat=? where idsupplier='"+txtkode.getText()+"'";
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txtkode.getText());
            stat.setString(2, txtnama.getText());
            stat.setString(3, txttlp.getText());
