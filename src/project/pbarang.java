...
public barangmasuk brg = null;
    ...
    public pbarang() {
     ...
     protected void datatable(){
        Object[] Baris={"Kode Barang","Nama Barang","Jenis","Unit","Harga","stok"};
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(114, 150, 180, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Object[] Baris = {"Kode Barang","Nama Barang","Jenis","Unit","Harga"};
        tabmode = new DefaultTableModel(null, Baris);
        tblbarang.setModel(tabmode);
        ...
        try {
            ...
            while (hasil.next()) {
                ...
                String[] data = {kode,nama,jenis,harga,ukuran};
    ...
    private void bkembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bkembaliActionPerformed
        ...
        barangmasuk menu = new barangmasuk(ID);
